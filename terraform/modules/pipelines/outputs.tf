...
output "demo-sam-app2-github_role_arn" {
    value = module.demo-sam-app2.github_role_arn
}

output "demo-sam-app2-source_bucket_name" {
    value = module.demo-sam-app2.source_bucket_name
}

output "demo-sam-app2-promotion_bucket_arn" {
    value = module.demo-sam-app2.promotion_bucket_arn
}

output "demo-sam-app2-promotion_event_trigger_role_arn" {
    value = module.demo-sam-app2.promotion_event_trigger_role_arn
}
